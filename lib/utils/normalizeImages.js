...
var resizedImageLocatorFolder = (0, _options2.default)().resizedImageLocatorFolder;
var originalWebpageScreenshotFolder = (0, _options2.default)().originalWebpageScreenshotFolder;
var sameSizeWebpageFolder = (0, _options2.default)().sameSizeWebpageFolder;
var doubleSizeWebpageFolder = (0, _options2.default)().doubleSizeWebpageFolder;
var halfSizeWebpageFolder = (0, _options2.default)().halfSizeWebpageFolder;

exports.default = async function normalizeImages(elementLocatorImagePath, elementLocatorName, imageReductionPerformanceFactor) {
